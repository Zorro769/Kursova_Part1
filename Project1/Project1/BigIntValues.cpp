...
//CharacterString& BigIntValues::operator+(const CharacterString& a) {
//	int t = 0, s = 0, i, m, n;
//	CharacterString temp;
//	temp.pStrStart = pStrStart;
//	if (strlen(temp.pStrStart) == 0)
//		n = strlen(temp.pStrStart) + 1;
//	else
//		n = strlen(temp.pStrStart);
//	if (strlen(a.pStrStart) == 0)
//		m = strlen(a.pStrStart) + 1;
//	else
//		m = strlen(a.pStrStart);
//	if (m > n) {
//		temp.pStrStart = BigIntValues::Append(temp.pStrStart, m - n, '0');
//	}
//	if (strlen(a.pStrStart) == 0)
...
//			s = temp1 + t;
//		t = s / 10;
//		temp.pStrStart[i] = (s % 10) + '0';
//	}
//	if (t) {
//		temp.pStrStart = BigIntValues::Append(temp.pStrStart, 1, t + '0');
//	}
